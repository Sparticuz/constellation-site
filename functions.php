...
function prefix_insert_post_ads( $content ) {
	if ( is_single() && ! is_admin() ) {
		...
		$code.= '<style>.blog-metadata .rrssb-buttons span{border-top:0;}.rrssb-buttons li a{border-radius:0;';
		$code.= 'font-size:inherit;padding:0;}.rrssb-buttons.large-format li a .text{font-size:2em;}</style>';
