...
<div id="content">
	...
	<figure class="hero homepage ceiling">
		...
		<figcaption class="why">Using the Historic<br/>Craft of Letterpress<span class="together">to bring people together</span><img class="inheritWidth" src="http://beta.constellationco.com/wp-content/uploads/2014/03/card.png" class="littleguy"></figcaption>
	</figure>
	...
	<div id="inner-content" class="wrap clearfix">
		...
		<div id="main" class="twelve columns first clearfix" role="main">
			...
			<section class="three column sidebarbody">
				...
				<a href="/product/category/featured/">View Our Products</a>
				<h3>Work With Us</h3>
