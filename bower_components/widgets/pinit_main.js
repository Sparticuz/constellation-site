        ...
        showFloatingButton: function (img) {
          ...
          if (img.height > $.a.minImgSize && img.width > $.a.minImgSize && !img.src.match(/^data/)) {
            ...
            if (c.id) {
              ...
              // set the button href
              href = $.v.endpoint.create + 'guid=' + $.v.guid + '&url=' + encodeURIComponent(img.getAttribute('data-pin-url') || $.d.URL) + '&media=' + encodeURIComponent(img.src) + '&description=' + encodeURIComponent(img.getAttribute('data-pin-description') || img.title || img.alt || $.d.title);
              $.s.floatingButton = $.f.make({'A': {
                'className': buttonClass,
                'title': 'Pin it!',
